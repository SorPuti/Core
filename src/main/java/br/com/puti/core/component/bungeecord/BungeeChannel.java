package br.com.puti.core.component.bungeecord;
...
public class BungeeChannel {
	 ...
	 */
	public synchronized static BungeeChannel of(CoreLoader loader) {
		return registeredInstances.compute(loader.getPluginLoader(), (k, v) -> {
			if (v == null)
				v = new BungeeChannel(loader);
			return v;
		});
	}

	public BungeeChannel(CoreLoader loader) {
		this.plugin = Objects.requireNonNull(loader.getPluginLoader(), "plugin cannot be null");
