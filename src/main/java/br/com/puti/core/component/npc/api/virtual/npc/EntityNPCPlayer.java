...
public class EntityNPCPlayer extends EntityPlayer implements NPCHolder {
	...
	public EntityNPCPlayer(Location spawn, NPC npc) {
		...
		this.getBukkitEntity().setMetadata("npc",
				new FixedMetadataValue(Core.getPlugin(Core.class), "npc_" + getName()));
	...
	static GameProfile makeProfile(NPC npc) {
		GameProfile profile = new GameProfile(npc.getUniqueId(), npc.getNome());
